...
var Game = /** @class */ (function () {
    function Game(onGameOver, isActiveSound) {
        var _this = this;
    ...
    Game.prototype.soundCoin = function () {
        if (this.isActiveSound) {
            var audio = new Audio('src/sounds/smb_coin.wav');
            audio.play();
        }
    };
    Game.prototype.soundGameOver = function () {
        if (this.isActiveSound) {
            var audio = new Audio('src/sounds/smb_gameover.wav');
            audio.play();
        }
    };
    Game.prototype.soundJump = function () {
        if (this.isActiveSound) {
            var audio = new Audio('src/sounds/smb_jump-small.wav');
            audio.play();
        }
    };
    Game.prototype.soundGoomba = function () {
        if (this.isActiveSound) {
            var audio = new Audio('src/sounds/smb_kick.wav');
            audio.play();
        }
    };
    ...
    Game.prototype.update = function () {
        ...
        this.game.physics.arcade.overlap(this.player, this.goombas, function (player, goomba) { return _this.goombaOverlap(player, goomba); });
    ...
    Game.prototype.goombaOverlap = function (player, goomba) {
        var _this = this;
...
var Application = /** @class */ (function () {
    function Application() {
        this.introSoundEnable = true;
        this.gameStarted = false;
        var oldValue = sessionStorage.getItem('introSoundEnable');
        if (oldValue) {
            var muted = eval(oldValue);
            document.querySelector('audio#intro')['muted'] = muted;
            this.introSoundEnable = !muted;
        }
    }
    Application.prototype.handlingSound = function () {
        var audio = document.querySelector('audio#intro');
    ...
    Application.prototype.stopIntro = function () {
        var audio = document.querySelector('audio#intro');
        audio.pause();
        audio.currentTime = 0;
    };
    Application.prototype.playIntro = function () {
        var audio = document.querySelector('audio#intro');
        audio.play();
    };
    Application.prototype.startGame = function () {
        ...
        if (!this.gameStarted) {
            ...
            this.stopIntro();
            new _game__WEBPACK_IMPORTED_MODULE_1__["Game"](function () {
...
capivarajs__WEBPACK_IMPORTED_MODULE_0___default.a.controller(document.body, Application);
